                                ...
                                <div class="product-card">
                                    ...
                                    <div class="rating">
                                        <div class="rating-stars">
                                            <input type="radio" name="star" id="1"><label for="1"><label for="1"></label>
                                            <input type="radio" name="star" id="2"><label for="2"><label for="1"></label>
                                            <input type="radio" name="star" id="3"><label for="3"><label for="1"></label>
                                            <input type="radio" name="star" id="4"><label for="4"><label for="1"></label>
                                            <input type="radio" name="star" id="5"><label for="5"><label for="1"></label>
                                        </div>                                   
